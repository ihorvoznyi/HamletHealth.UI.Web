...
import { options } from '@components/features/forms/create-account-form/index.schema';
...
import { RegistrationFormType } from '@components/features/forms/create-account-form/index.types';
